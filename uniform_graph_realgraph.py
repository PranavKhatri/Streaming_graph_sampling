...
if __name__ == "__main__":
    ...
    handleArgs()
    deletePathIfNeeded(args.out_directory_stem +'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/')  
    createPathIfNeeded(args.out_directory_stem +'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/')

    for snapshot in range(1, args.snapshots+1):
        org_data_suffix= 'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/output-prefix.t0000'+ str(snapshot-1)+'.graph'
        org_community_suffix= 'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/output-prefix.t0000'+ str(snapshot-1)+'.dat'
        normalized_community_suffix= 'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/output-prefix.t0000'+ str(snapshot-1)+'.comms'
        # org_data_suffix= 'new_'+args.dataset+'u_'+ string(int(100*mu))+'/'+args.dataset+'.t0'+ snapshot+'.edges'
        # org_community_suffix= 'new_'+args.dataset+'u_'+ string(int(100*mu))+'/'+args.dataset+'.t0'+ snapshot+'.comm'

#        if args.dataset == "enron":
        shutil.copy(args.bench_directory_stem + 'new_'+args.dataset+'_u_'+ str(int(100*args.mu))+'/'+ str(snapshot)+'.txt', args.out_directory_stem + org_data_suffix)           
#        rewriteEdgelistFromZero(args.out_directory_stem + org_data_suffix, ' ')
...
#            rewriteClusteringFromZero( args.out_directory_stem + normalized_community_suffix, ' ')   
