...
###add by zhukaijie#####
#def add_other_components_partition_into_part(part, graph, main_components):
...
if __name__ == "__main__":
    ...
    sample_size = ['0.150000', '0.300000', '0.450000', '0.600000']
    ...
    while ( i < total_snapshots ):
        ...
        originalfile = './original_snapshot/output-prefix.t0000' + str(i) + '.graph'
...
#        igr = igraph.Graph(n = original_snapshot_graph.number_of_nodes(), edges = nx.convert_node_labels_to_integers(original_snapshot_graph, first_label=0).edges())
        ...
        while ( j < total_directories ):
            ...
            while ( k < total_samplesizes ):
                ...
                edgefile = './' + snapshot_directory[j] + '/' + sample_size[k] + '/output-prefix.t0000'+ str(i) + '.graph'
                ...
                complete_tcommsfile = './tcomms/full/' + snapshot_directory[j] + '_' + sample_size[k] + '_output-prefix.tcomms'
                if (complete_tcommsfile not in complete_tcomms.keys()) :
                    complete_tcomms[complete_tcommsfile] = []
             
                complete_commsfile = './' + snapshot_directory[j] + '/' + sample_size[k] + '_full_comms/output-prefix.t0000'+ str(i) + '.graph'
    ...
    for filename in complete_tcomms.keys():
        ...
        for line in complete_tcomms[filename]:
