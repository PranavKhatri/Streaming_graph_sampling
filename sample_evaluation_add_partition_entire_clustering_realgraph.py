...
#    percentages = [0.15]
    ...
    ############summraize  the distribution
                ...
                if per == percentages[0] and rep==0 and i== snapshot-1:  #only draw the distribution of the first trial and first percentage and the last snapshot. nice.
                    # orig_eccentricity = nx.diameter(original)
                    # orig_radius = nx.radius(original)
                    # eccentricity = nx.diameter(sample)
                    # radius = nx.radius(sample)
                    ...
                    if per == percentages[0] and rep==0 and sampling_algorithm =='new_pies' :
        ...
        if sampling_algorithm =='new_pies':       
            sample_title_str ='Sample_algohm'+','+title_str
