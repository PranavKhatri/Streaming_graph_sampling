...
supported_modules = ['generate', 'sample', 'cluster','evaluate' ,'measure', 'visualize']
...
for n in args.n_list:
    ...
    if 'generate' in args.modules:
        ...
        command_list.append('generate_real_mutiple_graph.py')
...
#        command_list.append('0.7')
    ...
    if 'evaluate' in args.modules:
        #python measure_mutiple_result.py -b generated_benches_u60_p_10_condition_induced_random_edge/n_65608366/ -gt  community_year_level_v1.dat community_studentfac_level_v1.dat community_secondmajor_level_v1.dat community_majorindex_level_v1.dat  community_gender_level_v1.dat community_highschool_level_v1.dat

        command_list = []
        command_list.append('python')
        command_list.append('evaluation_mutiple_result_sep.py')
        ...
        command_list.append('-b')
        command_list.append(working_directory)
        command_list.append('-gt')
        if args.mu !=0.1:
            command_list.append('community_year_level_v1.dat')
            command_list.append('community_studentfac_level_v1.dat')
            command_list.append('community_secondmajor_level_v1.dat')
            command_list.append('community_majorindex_level_v1.dat')
            command_list.append('community_gender_level_v1.dat')
            command_list.append('community_highschool_level_v1.dat')
            command_list.append('community_dorm_level_v1.dat')
        else:
            command_list.append('community_00_level_v1.dat')
            command_list.append('community_01_level_v1.dat')
            command_list.append('community_02_level_v1.dat')
            command_list.append('community_03_level_v1.dat')
            command_list.append('community_04_level_v1.dat')
            command_list.append('community_05_level_v1.dat')
            command_list.append('community_06_level_v1.dat')
            command_list.append('community_07_level_v1.dat')
            command_list.append('community_08_level_v1.dat')
            command_list.append('community_09_level_v1.dat')
            command_list.append('community_10_level_v1.dat')
...
#        command_list.append(str(args.numtrials))   
        order_evaluate = ' '.join(command_list)
#        command_list.append('-o')
#        command_list.append(working_directory)
